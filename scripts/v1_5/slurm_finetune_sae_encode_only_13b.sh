...
PRETRAIN_PROJECTOR="$SCRATCH/checkpoints/llava-v1.5-13b-pretrain-sae-encode-only-${SAE_TAG}/mm_projector.bin"
OUTPUT_DIR="$SCRATCH/checkpoints/llava-v1.5-13b-finetune-sae-encode-only-${SAE_TAG}"
