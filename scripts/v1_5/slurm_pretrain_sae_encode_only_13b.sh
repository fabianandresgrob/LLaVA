#!/bin/bash
#SBATCH --job-name=llava-sae-eo-pt-13b
...
OUTPUT_DIR="$SCRATCH/checkpoints/llava-v1.5-13b-pretrain-sae-encode-only-${SAE_TAG}"
...
# Trains ONLY the new 8192->5120 projector. CLIP, LLM, and SAE are all frozen.
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "Next: run slurm_finetune_sae_encode_only_13b.sh"
else
